...
{	
	public $permissions_list = array('galleries', 'pages', 'blog', 'comments', 'feedbacks', 'issues', 'design', 'settings', 'managers', 'users', 'groups', 'tokeet', 'products', 'categories', 'brands', 'features', 'orders', 'labels', 'coupons', 'currency', 'delivery', 'payment','inventories');
