...
{* Title *}
{$meta_title='Categories' scope=parent}

{* Заголовок *}
<div id="header">
	<h1>Categories</h1>
	<a class="add" href="{url module=CategoryAdmin return=$smarty.server.REQUEST_URI}">Add new category</a>
</div>	
<!-- Заголовок (The End) -->
			...
			<div class="{if !$category->visible}invisible{/if} row">		
				<div class="tree_row">
					...
					<div class="icons cell">
						<a class="preview" title="Preview in new window" href="../catalog/{$category->url}" target="_blank"></a>				
