...
<link href="{$config->root_url}/design/{$settings->theme|escape}/fonts/fa/font-awesome.min.css?v4.7.0" rel="stylesheet">
<link href="design/css/style.css?v1.0.21" rel="stylesheet" type="text/css" />
...
<div id="main">
	...
	{if in_array('pages', $manager->permissions)}
		<li><a href="?module=PagesAdmin"><img src="design/images/menu/pages.png"><b>Pages</b></a></li>
	{/if}
		
	{if in_array('blog', $manager->permissions)}
		<li><a href="?module=BlogAdmin"><img src="design/images/menu/blog.png"><b>Blog</b></a></li>
	{/if}
    
	{if in_array('feedbacks', $manager->permissions)}
		<li><a href="?module=FeedbacksAdmin"><img src="design/images/menu/comments.png"><b>Comments</b></a>
	{/if}

	{if in_array('users', $manager->permissions)}
		<li><a href="?module=UsersAdmin"><img src="design/images/menu/users.png"><b>Guests</b></a>
	{/if}



	{if in_array('products', $manager->permissions)}
		<li><a href="index.php?module=ProductsAdmin"><img src="design/images/menu/catalog.png"><b>Products</b></a></li>
	{elseif in_array('categories', $manager->permissions)}
		<li><a href="index.php?module=CategoriesAdmin"><img src="design/images/menu/catalog.png"><b>Products</b></a></li>
	{elseif in_array('brands', $manager->permissions)}
		<li><a href="index.php?module=BrandsAdmin"><img src="design/images/menu/catalog.png"><b>Products</b></a></li>
	{elseif in_array('features', $manager->permissions)}
		<li><a href="index.php?module=FeaturesAdmin"><img src="design/images/menu/catalog.png"><b>Products</b></a></li>
	{/if}

	{if in_array('inventories', $manager->permissions)}
		<li>
			<a href="index.php?module=InventoriesHousesAdmin&type=1"><img src="design/images/menu/statistics.png"><b>Restocking</b></a>
			{if $new_inventories_counter}
				<div class='counter'><span>{$new_inventories_counter}</span></div>
			{/if}
		</li>
	{/if}
	...
	{if in_array('orders', $manager->permissions)}
		<li>
			<a href="index.php?module=OrdersAdmin"><img src="design/images/menu/orders.png"><b>Invoices &amp; Orders</b></a>
			{if $new_orders_counter}<div class='counter'><span>{$new_orders_counter}</span></div>{/if}
		</li>
	{elseif in_array('labels', $manager->permissions)}
		<li><a href="index.php?module=OrdersLabelsAdmin"><img src="design/images/menu/orders.png"><b>Orders</b></a></li>
	{/if}
	...
	{*
		...
		<li><a href="?module=IssuesAdmin"><img src="design/images/menu/comments.png"><b>Technical Issues</b></a>
	{/if}
		
	{if in_array('design', $manager->permissions)}
		<li><a href="?module=ThemeAdmin"><img src="design/images/menu/design.png"><b>Design</b></a></li>
	{/if}
    *}
	
	{if in_array('settings', $manager->permissions)}
		<li><a href="?module=SettingsAdmin"><img src="design/images/menu/settings.png"><b>Settings</b></a></li>
	{elseif in_array('delivery', $manager->permissions)}
		<li><a href="?module=DeliveriesAdmin"><img src="design/images/menu/settings.png"><b>Settings</b></a></li>
	{elseif in_array('payment', $manager->permissions)}
		<li><a href="?module=PaymentMethodsAdmin"><img src="design/images/menu/settings.png"><b>Settings</b></a></li>
	{elseif in_array('managers', $manager->permissions)}
		<li><a href="?module=ManagersAdmin"><img src="design/images/menu/settings.png"><b>Settings</b></a></li>
	{/if}
	...
	<!-- Подвал сайта -->
	<div id="footer">
	You are logged in as {$manager->login}.
	<a href='{$config->root_url}?logout' id="logout">Logout</a>
	</div>
