{capture name=tabs}
	...
	<li class="active"><a href="index.php?module=TemplatesAdmin">Templates</a></li>		
	<li><a href="index.php?module=StylesAdmin">Styles</a></li>		
	<li><a href="index.php?module=ImagesAdmin">Images</a></li>		
{/capture}
...
<div class="message message_error">
	<span class="text">
	{if $message_error == 'permissions'}Set writable permissions to the file {$template_file}
