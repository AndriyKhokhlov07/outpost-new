...
*}
    ...
    {if in_array($page->id, [193, 475, 476, 356, 301]) || $page->menu_id==15 || $noindex_nofollow}
    <meta name="robots" content="noindex, nofollow">
    {/if}
    {if $author || $tag || $noindex_follow}
...
{/if}
    ...
    {* Стили *}
    <link href="design/{$settings->theme|escape}/fonts/fa/font-awesome.min.css?v4.7.0.1" rel="stylesheet">
    <link href="design/{$settings->theme|escape}/js/slick/slick.css" rel="stylesheet">
    <link href="design/{$settings->theme|escape}/js/slick/slick-theme.css?v1.0.0" rel="stylesheet">
    <link href="js/fancybox/jquery.fancybox.min.css" rel="stylesheet">

    <link href="design/{$settings->theme|escape}/css/style.css?v1.0.275" rel="stylesheet">
    <link href="design/{$settings->theme|escape}/css/style2.css?v1.0.79" rel="stylesheet">

    {if $page->menu_id == 5 && $page->parent_id != 0 && !$lighthouse}
...
Book by April 30, 2020, with move-in by Aug. 31, 2020, and you can cancel or reschedule your stay up until 7 days before your move-in date.</div>*}
            ...
            <ul class="menu">
                ...
                {if $user->type!=3}
                <li>
                    <a href="https://ne-bo.com/user/login" target="_blank" rel="nofollow">Current Members</a>
                </li>
                {if $categories}
            ...
            <ul class="menu">
                ...
                <li class="menu_about">
                    ...
                    <ul class="hide">
                        ...
                        {*<li>
                            <a href="/the-gramercy-park-studios">Short-Term Solutions</a>
                        </li>*}
                        <li>
                ...
                {foreach $pages as $p}
                    {if $p->menu_id==1}
                        ...
                        <li class="{if $page && $page->id == $p->id}selected{/if}">
                            <a href="{if $p->url=='join-us'}/online-questionnaire{else}{$p->url}{/if}"{if $p->id == 100} class="button"{/if}>{$p->name|escape}</a>
                        </li>
                        {elseif $p->url == 'our-houses'}
                        <li class="menu_about">
                            <span>Our houses</span>
             ...
             <ul class="menu">
                ...
                {foreach $pages as $p}
                    {if $p->menu_id==1}
                         {if $p->url == 'join-us'}
                        <li{if $page && $page->id == $p->id && !$author && !$tag} class="selected"{/if}>
                            {*<a href="{if $apply_form}#apply{elseif $apply_link}{$apply_link}{else}/online-questionnaire{/if}" class="button {if $apply_form}anchor{/if}">{$p->name|escape}</a>
   ...
   <div class="footer">
        ...
        <div class="fx c v vc grey">
            ...
            <div class="socials fx">
                ...
                <a href="http://instagram.com/outpost_club" target="_blank" rel="nofollow noopener noreferer">
                    <img src="/design/{$settings->theme|escape}/images/icons/instagram.svg" alt="Outpost instagram">
                </a>
                <a href="https://twitter.com/outpost_club" target="_blank" rel="nofollow noopener noreferer">
                    <img src="/design/{$settings->theme|escape}/images/icons/twitter.svg" alt="Outpost twitter">
                </a>
                <a href="https://www.linkedin.com/company-beta/17932725/" target="_blank" rel="nofollow noopener noreferer">
                    <img src="/design/{$settings->theme|escape}/images/icons/linkedin.svg" alt="Outpost linkedin">
                </a>
                <a href="http://www.facebook.com/outpostclubNY/" target="_blank" rel="nofollow noopener noreferer">
