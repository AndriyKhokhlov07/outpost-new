<div class="land furnished_r">
	...
	<div class="first_block">
		...
		<div class="right_bl fx v vc">
			<p>College can be stressful enough without having to worry about finding student housing in Philadelphia. So whether you’re looking for an apartment for the summer or the entire time you’re in school Outpost Club has you covered!</p>
...
<div class="main_width">
	<div class="advantages">
		...
		<div class="center">
			<a href="philly-questionnaire" class="button2 red">Apply now</a>
		</div>
	</div>
</div>
<div class="w100">
	<div class="main_width txt center">
		<h2 class="h1 center">The Temple 1 House</h2>
		<p>The Temple 1 House, also known as the Tech Mansion, is a live-in accelerator perfect for students, entrepreneurs, content creators, and innovators to come together and create something unforgettable. Complete with common spaces that are fully furnished with a shared work area to co-work with your housemates and ideate on your next big project! This house features a podcast studio for content creators to facilitate your recordings. Not to mention washers and dryers are also available, so you'll never have to worry about finding an open machine at the laundromat again.</p> 
 		<p>Located in the heart of North Philadelphia East, right next to Temple University and within easy reach of downtown Philadelphia. This brand-new building with luxury amenities is the perfect way to ensure you experience all the best parts of college life and off-campus life.</p> 
	</div>
	<div class="fx gall w">	
		<a class="img" href="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-13.jpg" data-fancybox="gall"><img src="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-13.jpg" title="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-3), outpost-club.com" alt="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-3)" ></a>
		<a class="img" href="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-11.jpg" data-fancybox="gall"><img src="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-11.jpg" title="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-4), outpost-club.com" alt="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-4)" ></a>
		<a class="img" href="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-12.jpg" data-fancybox="gall"><img src="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-12.jpg" title="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-5), outpost-club.com" alt="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-5)" ></a>
		<a class="img" href="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-14.jpg" data-fancybox="gall"><img src="/design/{$settings->theme|escape}/images/landing/offcampus/offcampus-philly-14.jpg" title="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-6), outpost-club.com" alt="Off-Campus Student Housing In Philadelphia: Apply Today! (Image-6)" ></a>
	</div>
</div>
{*<div class="w100">
	<div class="main_width txt center">
		<h2 class="h1 center">The Mason on Chestnut</h2>
