$(function(){
    ...
    // let imgBlockH = $('.image_block:first').height() / 2;
    // let scrollVar1 = imgBlockH;
    setTimeout(() => {
    ...
    let scrolled200 = false;
    window.addEventListener('scroll', (evt) => {
        // scrollVar1 = imgBlockH - window.scrollY * 2;
        // document.body.style.setProperty('--scrollVar1', (scrollVar1 > 0 ? scrollVar1 : 0));
        // document.body.style.setProperty('--scrollPosition', window.scrollY);
        // console.log(window.scrollY);
        scrolled200 = (window.scrollY >= 50) ? true : false;
        if (scrolled200) {
