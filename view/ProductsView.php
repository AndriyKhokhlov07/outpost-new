	...
	function fetch()
	{
		...
		if(!empty($products))
		{
			...
			foreach($variants as &$variant)
			{
				...
				// if(
				// 	($this->group->opt == 1 && $variant->price_opt>0) || 
				// 	($this->group->opt == 2 && $variant->price_opt2==0 && $variant->price_opt>0)
				// ){
				// 	$variant->compare_price = $variant->price;
				// 	$variant->price = $variant->price_opt;
				// }
				// elseif($this->group->opt == 2 && $variant->price_opt2>0){
				// 	$variant->compare_price = $variant->price;
				// 	$variant->price = $variant->price_opt2;
				// }
